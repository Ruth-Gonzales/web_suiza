...
const PHONE_NUMBER = '51999999999';
...
export default function WhatsAppHighlight({ t }) {
  ...
  return (
    <section className="mb-16">
      <div className="rounded-[2.5rem] bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-800 p-8 md:p-10 shadow-lg text-center relative overflow-hidden">
        <div className="absolute -top-12 -right-12 w-40 h-40 bg-white/10 dark:bg-white/[0.03] rounded-full blur-3xl" />
        <div className="absolute -bottom-12 -left-12 w-32 h-32 bg-white/10 dark:bg-white/[0.03] rounded-full blur-3xl" />
