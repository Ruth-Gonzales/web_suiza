    ...
    return (
      <section id="form" className="mb-12">
        <div className="max-w-xl mx-auto rounded-[2rem] bg-white dark:bg-dark-card border border-primary/10 dark:border-white/8 p-10 shadow-sm text-center">
          ...
          <h3 className="text-lg font-bold text-slate-text dark:text-white mb-2">{form.success}</h3>
          <p className="text-sm text-slate-text/60 dark:text-dark-text/60 mb-6">{form.successMessage}</p>
          <button
