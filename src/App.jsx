...
function App(){
  ...
  const mainContent = (
    <div className="app-shell min-h-screen flex flex-col transition-colors duration-300 bg-bg-general dark:bg-dark-bg text-slate-text dark:text-dark-text relative" style={{ animation: 'app-slide-up 1s ease-out' }}>
