...
function DocenteModal({ docente, programa, allDocentes, currentIndex, onNavigate, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100]" style={{ perspective: '1200px' }}>
      ...
      <button onClick={(e) => { e.stopPropagation(); onClose(); }} className="absolute top-6 right-6 w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/25 text-white transition-all cursor-pointer flex items-center justify-center z-[110]">✕</button>
